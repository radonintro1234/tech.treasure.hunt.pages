...
<body class="u-body">
    ...
    <div class="row">
        ...
        <div class="col-md-5 mt-5">
            <div class="container bg-light text-center pt-5 pb-5 border border-dark questionDiv ">
                <img id="questionImg" src="quesImages/<?php echo $_SESSION['currentQues'] ?>" style="width:35rem; ">
            </div>
        </div>
        <!-- answer section -->
        <div class="col-md-7 mt-5">
            <section class=" u-clearfix u-section-1 " id="carousel_f8f3 ">
                    ...
                    <div class="u-align-center u-container-style u-group u-group-1 answerDiv border border-danger rounded-lg ">
                        <div class="u-container-layout u-valign-top u-container-layout-1 ">
                            ...
                            <div class="u-align-left u-expanded-width-xs u-form u-form-1 ">
                                <form action="include/check_ans.php" method="POST" class="u-clearfix u-form-spacing-28 u-form-vertical u-inner-form " style="padding: 10px " source="email " name="form ">
                                    ...
                                    <div class="u-form-group u-form-name u-form-group-1 ">
                                        ...
                                        <input type="text " placeholder="Enter your Answer " id="answer" name="answer" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-white " required=" ">
